...
export const setupOrbitControls = (camera: THREE.PerspectiveCamera, canvas: HTMLCanvasElement) => {
...
export const renderingManager = (
	...
	reducedMotionPreference.addEventListener("change", (event: MediaQueryListEvent) => {
		if (event.matches) startRendering()
		else stopRendering()
	})

	return { startRendering, stopRendering, initRendering, reducedMotionPreference }
}
